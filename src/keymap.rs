...
impl Keymap {
    ...
    fn global_action(code: KeyCode) -> Option<KeyAction> {
        match code {
            KeyCode::Char('?') | KeyCode::F(1) => Some(KeyAction::ToggleHelp),
    ...
    fn vim_action(context: KeyContext, code: KeyCode) -> Option<KeyAction> {
        match context {
            ...
            KeyContext::List => match code {
                ...
                KeyCode::Char('g') | KeyCode::Home => Some(KeyAction::JumpTop),
                KeyCode::Char('G') | KeyCode::End => Some(KeyAction::JumpBottom),
                KeyCode::Char('r') | KeyCode::F(5) => Some(KeyAction::Refresh),
            ...
            KeyContext::Comments => match code {
                ...
                KeyCode::Char('/') | KeyCode::F(3) => Some(KeyAction::StartSearch),
                KeyCode::Char('n') | KeyCode::F(4) => Some(KeyAction::NextMatch),
